...
public final class WorldLayoutData {
     ...
     * Cube vertices
     */
    public static final float AD_CUBE_COORDS[][] = {
            {     // front
                    -1.0f, -1.0f, 1.0f,
                    1.0f, -1.0f, 1.0f,
                    1.0f, 1.0f, 1.0f,
    ...
    public static final String[] AD_SPACE_IDS = { "47", "48", "49", "47", "48", "49" };
    //public static final String[] AD_SPACE_IDS = { "106", "107", "57", "106", "107", "57" };

    public static final long[] ADS = new long[6];
